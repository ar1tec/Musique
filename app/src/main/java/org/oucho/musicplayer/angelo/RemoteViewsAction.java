...
import static org.oucho.musicplayer.angelo.Utils.getService;
...
abstract class RemoteViewsAction extends Action<RemoteViewsAction.RemoteViewsTarget> {
    ...
    RemoteViewsAction(Angelo angelo, Request data, RemoteViews remoteViews, int viewId, int errorResId, int memoryPolicy, Object tag, String key, Callback callback) {
        super(angelo, null, data, memoryPolicy, errorResId, null, key, tag, false);
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Angelo angelo, Request data, RemoteViews remoteViews, int viewId, int[] appWidgetIds, int memoryPolicy, String key, Object tag, int errorResId, Callback callback) {
            super(angelo, data, remoteViews, viewId, errorResId, memoryPolicy, tag, key, callback);
