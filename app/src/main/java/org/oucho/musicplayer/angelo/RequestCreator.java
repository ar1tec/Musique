...
import static org.oucho.musicplayer.angelo.Angelo.LoadedFrom.MEMORY;
import static org.oucho.musicplayer.angelo.Angelo.Priority;
import static org.oucho.musicplayer.angelo.AngeloDrawable.setBitmap;
import static org.oucho.musicplayer.angelo.AngeloDrawable.setPlaceholder;
import static org.oucho.musicplayer.angelo.RemoteViewsAction.AppWidgetAction;
import static org.oucho.musicplayer.angelo.RemoteViewsAction.NotificationAction;
import static org.oucho.musicplayer.angelo.Utils.checkMain;
import static org.oucho.musicplayer.angelo.Utils.checkNotMain;
import static org.oucho.musicplayer.angelo.Utils.createKey;
...
public class RequestCreator {
     ...
     * <p>
     * By default, Angelo will either set a supplied placeholder or clear the target
    ...
    public Bitmap get() throws IOException {
        ...
        Action action = new GetAction(angelo, finalData, memoryPolicy, tag, key);
    ...
    public void fetch(@Nullable Callback callback) {
        ...
        if (data.hasImage()) {
            ...
            Action action = new FetchAction(angelo, request, memoryPolicy, tag, key, callback);
    ...
    public void into(@NonNull Target target) {
        ...
        Action action = new TargetAction(angelo, target, request, memoryPolicy, errorDrawable, requestKey, tag, errorResId);
     ...
     * {@link Angelo#cancelRequest(ImageView)} call to prevent temporary leaking.
     */
    public void into(ImageView target, Callback callback) {
        ...
        if (shouldReadFromMemoryCache(memoryPolicy)) {
            ...
            if (bitmap != null) {
                angelo.cancelRequest(target);
                setBitmap(target, angelo.context, bitmap, MEMORY, noFade, angelo.indicatorsEnabled);
                if (callback != null) {
                    callback.onSuccess();
                }
                return;
        ...
        Action action = new ImageViewAction(angelo, target, request, memoryPolicy, errorResId, errorDrawable, requestKey, tag, callback, noFade);
