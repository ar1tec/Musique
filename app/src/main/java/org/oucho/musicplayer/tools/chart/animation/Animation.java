...
import org.oucho.musicplayer.tools.chart.view.ChartView;
...
public class Animation {
    ...
    private ArrayList<ChartSet> animate(ArrayList<float[][]> start, ArrayList<float[][]> end) {
        ...
        animator.addUpdateListener(animation -> mCallback.onAnimationUpdate(mData));
     ...
     *                     values
     * @return {@link org.oucho.musicplayer.tools.chart.animation.Animation} self-reference.
     */
