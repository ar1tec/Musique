...
import org.oucho.musicplayer.tools.chart.util.Tools;

import static org.oucho.musicplayer.tools.chart.util.Preconditions.checkNotNull;
import static org.oucho.musicplayer.tools.chart.util.Preconditions.checkPositionIndex;


/**
 * Data model containing a set of {@link org.oucho.musicplayer.tools.chart.model.Point} to be used by {@link
 * org.oucho.musicplayer.tools.chart.view.LineChartView}.
 */
public class LineSet extends ChartSet {
    ...
    /**
     * Add new {@link org.oucho.musicplayer.tools.chart.model.Point} from a string and a float.
     *
     * @param label new {@link org.oucho.musicplayer.tools.chart.model.Point}'s label
     * @param value new {@link org.oucho.musicplayer.tools.chart.model.Point}'s value
     */
    public void addPoint(String label, float value) {

        this.addPoint(new org.oucho.musicplayer.tools.chart.model.Point(label, value));
    }


    /**
     * Add new {@link org.oucho.musicplayer.tools.chart.model.Point}.
     *
     * @param point new {@link org.oucho.musicplayer.tools.chart.model.Point}
     */
    public void addPoint(@NonNull org.oucho.musicplayer.tools.chart.model.Point point) {
     ...
     * @return {@link org.oucho.musicplayer.tools.chart.model.LineSet} self-reference.
     */
    ...
    /**
     * Retrieve first {@link org.oucho.musicplayer.tools.chart.model.Point} that will be displayed for this set.
     *
     * @return first displayed {@link org.oucho.musicplayer.tools.chart.model.Point}.
     */
    public int getBegin() {
    ...
    /**
     * Retrieve last {@link org.oucho.musicplayer.tools.chart.model.Point} that will be displayed for this set.
     *
     * @return last displayed {@link org.oucho.musicplayer.tools.chart.model.Point}.
     */
    public int getEnd() {
    ...
    /**
     * Define at which {@link org.oucho.musicplayer.tools.chart.model.Point} should the dataset begin.
     *
    ...
    /**
     * Define at which {@link org.oucho.musicplayer.tools.chart.model.Point} should the dataset end.
     *
     ...
     * Color will be assigned to all {@link org.oucho.musicplayer.tools.chart.model.Point}s in the set.
     * Will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}.
     *
     ...
     * Radius will be assigned to all {@link org.oucho.musicplayer.tools.chart.model.Point}s in the set.
     * Will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}.
     *
    ...
    public LineSet setDotsRadius(@FloatRange(from = 0.f) float radius) {
        ...
        for (ChartEntry e : getEntries())
            ((org.oucho.musicplayer.tools.chart.model.Point) e).setRadius(radius);
        return this;
    }
     ...
     * Thickness will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}.
     * Will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}s.
     *
    ...
    public LineSet setDotsStrokeThickness(@FloatRange(from = 0.f) float thickness) {
        ...
        for (ChartEntry e : getEntries())
            ((org.oucho.musicplayer.tools.chart.model.Point) e).setStrokeThickness(thickness);
        return this;
    }
     ...
     * Color will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}.
     * Will override previous defined values for any {@link org.oucho.musicplayer.tools.chart.model.Point}s.
     *
    ...
    public LineSet setDotsStrokeColor(@ColorInt int color) {
        ...
        for (ChartEntry e : getEntries())
            ((org.oucho.musicplayer.tools.chart.model.Point) e).setStrokeColor(color);
        return this;
    }
    ...
    public LineSet setDotsDrawable(@NonNull Drawable drawable) {
        ...
        for (ChartEntry e : getEntries())
            ((org.oucho.musicplayer.tools.chart.model.Point) e).setDrawable(drawable);
        return this;
    }
