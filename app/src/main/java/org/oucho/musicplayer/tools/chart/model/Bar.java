...
/**
 * Data model that represents a bar in {@link org.oucho.musicplayer.tools.chart.view.BaseBarChartView}
 */
public class Bar extends ChartEntry {
    ...
    /**
     * Set gradient colors to the fill of the {@link org.oucho.musicplayer.tools.chart.model.Bar}.
     *
     ...
     * @return {@link org.oucho.musicplayer.tools.chart.model.Bar} self-reference.
     */
